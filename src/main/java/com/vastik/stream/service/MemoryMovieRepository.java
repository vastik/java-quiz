package com.vastik.stream.service;

import com.vastik.stream.model.Director;
import com.vastik.stream.model.Genre;
import com.vastik.stream.model.Movie;
import com.vastik.stream.search.MovieSearch;
...
public class MemoryMovieRepository {
    ...
    public Collection<Movie> findAllMoviesByCriteria(MovieSearch criteria) {
